...
```{bash eval=FALSE}
# Terminal
source $HOME/.bash_profile # or ~/.bash_profile
```
...
s3fs -o allow_other radseq /media/s3/   # mount s3 bucket 'radseq'
```
